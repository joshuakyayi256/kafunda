    ...
    if (!product) {
        return (
            <div className="min-h-[60vh] flex flex-col items-center justify-center">
                ...
                <Link href="/" className="text-primary-red font-bold hover:underline uppercase tracking-widest text-sm">
                    Return to Home
                </Link>
            </div>
        );
    ...
    return (
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <nav className="flex items-center space-x-2 text-xs font-bold uppercase tracking-widest text-gray-400 mb-8 overflow-x-auto whitespace-nowrap pb-2">
                ...
                <Link href={`/category/${product.category.toLowerCase()}`} className="hover:text-black transition-colors">{product.category}</Link>
                <ChevronRight className="h-3 w-3" />
                ...
                <div className="flex flex-col">
                    ...
                    <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4 mb-10">
                        ...
                        <div className="flex items-center border border-gray-200 rounded-md overflow-hidden w-full sm:w-auto">
                            ...
                            <span className="px-6 font-bold text-zinc-900 min-w-[50px] text-center">{quantity}</span>
                            <button
                        ...
                        <button
                            ...
                            className="flex-grow bg-primary-red hover:bg-primary-red-hover text-white py-4 px-8 font-bold text-sm tracking-widest uppercase transition-all flex items-center justify-center space-x-3 shadow-lg transform hover:scale-[1.02]"
                        >
...
const AccordionItem = ({ title, children, isOpen, toggle }: any) => (
    <div className="py-4">
        <button
            onClick={toggle}
